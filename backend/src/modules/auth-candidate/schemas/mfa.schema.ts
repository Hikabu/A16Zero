...
export const verifyMfaSchema = z.object({
  ...
  mfaToken: z
    .string()
    .describe('Temporary MFA session token')
...
export const verifyMfaRecoverySchema = z.object({
  ...
  backupCode: z
    .string()
    .describe('8-character recovery code')
...
export class VerifyMfaRecoveryDto extends createZodDto(
  verifyMfaRecoverySchema,
) {}
