...
export class ActionsController {
  ...
  getBlinkCard(
    ...
    res.json({
      ...
      description:
        "Cryptographically verify this developer's work. Costs ~$0.0002.",
      label: 'Vouch',
      links: {
        actions: [
          {
            ...
            parameters: [
              {
                name: 'message',
                label:
                  'What did you build or work on together? (max 200 chars)',
                required: true,
              },
            ],
          },
  ...
  @ApiQuery({
    name: 'message',
    description:
      'This field is used by the wallet - frontened should write the message in the body',
    required: false,
  })
